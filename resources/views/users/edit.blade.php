...
<div class="jumbotron p-2 m-4">
    ...
    <div class="container">
        <div class="row">
            ...
            <form class="p-4 m-3 border bg-gradient-info" enctype="multipart/form-data" action="{{route('admin.user.update',$user->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control"  id="">
                            ...
                            <option value="super_admin" @if($user->type=='super_admin') selected @endif>super_admin</option>
                        </select>
                    </div>
                    <div class="form-group">
